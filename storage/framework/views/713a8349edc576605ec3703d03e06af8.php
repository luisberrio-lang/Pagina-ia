      ...
      <div class="hidden md:flex flex-1 items-center justify-center gap-2">
        ...
        <a class="nav-item" href="<?php echo e(route('precio')); ?>">
          <span class="nav-ico" aria-hidden="true">
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                 stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M20.59 13.41 12 22 2 12l8.59-8.59A2 2 0 0 1 12 3h6a2 2 0 0 1 2 2v6a2 2 0 0 1-.59 1.41z"></path>
        ...
        <a class="nav-item" href="<?php echo e(route('soporte')); ?>">
          <span class="nav-ico" aria-hidden="true">
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
              ...
              <path d="M4 12v3a2 2 0 0 0 2 2h1v-7H6a2 2 0 0 0-2 2z"></path>
              <path d="M20 12v3a2 2 0 0 1-2 2h-1v-7h1a2 2 0 0 1 2 2z"></path>
              <path d="M12 19a3 3 0 0 0 3-3"></path>
            </svg>
          </span>
          <span>Soporte</span>
        </a>
