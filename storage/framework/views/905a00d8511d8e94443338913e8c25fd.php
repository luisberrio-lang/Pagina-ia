...
<div class="mx-auto max-w-md glass rounded-3xl p-8">
    ...
    <p class="text-white/70 mt-2">Regístrate en G Velarde para alguna consulta que desees. Si deseas información de los productos, no es necesario crear una cuenta; puedes ingresar directamente desde el inicio enviando un mensaje por WhatsApp.</p>
