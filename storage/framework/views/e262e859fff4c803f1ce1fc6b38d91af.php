  ...
  <div class="md:hidden px-4 pb-4" x-show="open" x-transition>
    <div class="glass rounded-2xl p-3 space-y-1">
      ...
      <div class="pt-2 flex gap-2">
        <a href="<?php echo e($waHeaderUrl); ?>" target="_blank" class="btn-tech flex-1">WhatsApp</a>
        <a href="<?php echo e($fbUrl); ?>" target="_blank" class="btn-tech flex-1">Facebook</a>
        <a href="<?php echo e($ytUrl); ?>" target="_blank" class="btn-tech flex-1">YouTube</a>
      </div>
    </div>
  </div>
</header>
